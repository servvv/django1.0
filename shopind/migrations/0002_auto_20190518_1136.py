# Generated by Django 2.1.3 on 2019-05-18 03:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('产品名称', models.CharField(max_length=50, unique=True)),
                ('产品描述', models.TextField(blank=True)),
                ('产品图片', models.ImageField(blank=True, upload_to='category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('类别描述', models.TextField(blank=True)),
        ...
        migrations.AddField(
            model_name='产品列表',
            name='所属类别',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shopind.商品类别表'),
        ),
    ]
